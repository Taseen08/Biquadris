...
GraphicsDisplay::GraphicsDisplay(size_t tw, size_t dw, size_t dh, size_t bw, size_t bh, Grid* b1, Grid* b2) : 
...
void GraphicsDisplay::removeBlind(Grid* b) {
	size_t blockSize = tw - 0.01;
	int black = 9;
	const vector<vector<Cell>> &tiles = b->getGrid();
