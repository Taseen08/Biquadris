...
Block *OneLev::NextBlock(int loc){
    ...
    if (this->random==false){
        ...
        this->blocks.clear();
        this->blocks = {'S','Z','I','I','J','J','L','L','O','O','T','T'};
        k = rand() % (this->blocks.size());
    }
    if (this->blocks[k] == 'I') return new iblock{false};
        else if (this->blocks[k] == 'J') return new jblock{false};
        else if (this->blocks[k] == 'L') return new lblock{false};
        else if (this->blocks[k] == 'O') return new oblock{false};
        else if (this->blocks[k] == 'S') return new sblock{false};
        else if (this->blocks[k] == 'Z') return new zblock{false};
