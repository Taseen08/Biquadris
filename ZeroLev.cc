...
Block* ZeroLev::NextBlock(int loc){
    ...
    if (this->blocks[j] == 'I') return new iblock{false};	
	else if (this->blocks[j] == 'J') return new jblock{false};
	else if (this->blocks[j] == 'L') return new lblock{false};
	else if (this->blocks[j] == 'O') return new oblock{false};
	else if (this->blocks[j] == 'S') return new sblock{false};
	else if (this->blocks[j] == 'Z') return new zblock{false};
